...
// All object classes inherit from this class
// It gives all object classes setter and getter functionality for their object spatial translation
// This gives all object classes draw(), update() and clean() functionality
class GameObject {
public:
	GameObject();
	~GameObject();
